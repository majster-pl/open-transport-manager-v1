...
<div
    class="@if($perPageInput) justify-between @else justify-end @endif md:flex md:flex-row w-full items-center pt-3 bg-white overflow-y-auto pl-2 pr-2 pb-1 relative dark:bg-gray-700">
    ...
    <div class="flex flex-row justify-center md:justify-start mb-2 md:mb-0">
        <div class="relative h-10">
            <select wire:model.lazy="perPage"
                ...
                <option value="{{$value}}" wire:click="gotoPage(1)">
                    @if($value == 0)
