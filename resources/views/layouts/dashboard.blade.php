...
<body class="font-sans antialiased" x-data="{menu_open: false}">
    ...
    <div class="flex h-screen z-20">
        ...
        <div x-bind:class="! menu_open ? '-left-64' : 'left-0'" @click.outside="menu_open = false"
            ...
            <ul class="relative px-1">
                ...
                {{-- home button --}}
                <x-menu-item-link class="my-3" :active="request()->routeIs('dashboard')" href="#">
                    <i class="ri-home-5-line mr-2 w-4"></i>
                    <span>Home</span>
                </x-menu-item-link>

                {{-- Outbound --}}
                <x-menu-item-link :active="request()->routeIs('outbound')" href="#">
                    <i class="ri-arrow-right-line mr-2 w-4"></i>
                    <span>Outbound</span>
                </x-menu-item-link>

                {{-- Inbound --}}
                <x-menu-item-link :active="request()->routeIs('inbound')" href="#">
                    <i class="ri-arrow-left-line mr-2 w-4"></i>
                    <span>Inbound</span>
                </x-menu-item-link>

                {{-- loads --}}
                <x-menu-item-link :active="request()->routeIs('loads')" href="#">
                    <i class="ri-luggage-cart-fill mr-2 w-4"></i>
                    <span>Loads</span>
                </x-menu-item-link>

                {{-- planning --}}
                <x-menu-item-link :active="request()->routeIs('planning')" href="#">
